          ...
          <div className={classes.alert}>
            ...
            <div>
              ...
              <Button
                ...
                onClick={() =>
                  dispatch(deleteDesigns(design._id, alert, onClose))
                }
              >
                Yes, Delete it!
              </Button>
    ...
    <>
              ...
              <Card chart>
                ...
                time and some other parameter */}
                    <div style={{ display: "flex", alignItems: "center" }}>
                      ...
                      ></div>
                      base{" "}
                      {design.currStoneShape ? (
                        <>
                          / {design.length} mm with {design.currStoneShape}
                        </>
                      ) : (
                        ""
                      )}
      ...
      {loading && (
        <div style={{ height: "70vh" }} className={classes.flexRow}>
          <Spinner
            style={{ height: "2rem", width: "2rem", alignSelf: "center" }}
          />
        </div>
      )}
    </>
